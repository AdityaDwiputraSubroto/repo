...
class _DiscussionListScreenState extends State<DiscussionListScreen> {
  ...
  void initState() {
    ...
    appController.TestAlldiscussionById(courseid);
    super.initState();
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemCount: appController.discussionByID.length,
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      '${appController.discussionByID[index].user.fullName}',
                                      style: TextStyle(
                                        fontSize: 16,
                                    ...
                                    Text(
                                      DateFormat('dd/MM/yyyy').format(
                                          DateTime.parse(
                                              '${appController.discussionByID[index].createdAt}')),
                                      style: TextStyle(
                                        fontSize: 12,
                            ...
                            Text(
                              '${appController.discussionByID[index].title}',
                              maxLines: 1,
                              style: TextStyle(
                                color: Colors.black,
                                fontWeight: FontWeight.bold,
                            ...
                            Text(
                              '${appController.discussionByID[index].body}',
                              maxLines: 3,
                              style: TextStyle(
                                color: Colors.black,
                                fontSize: 16,
